...
// const proofImages = [proof6, proof2, proof3, proof11, proof4, proof5, proof13, proof14, more1, more2, more5, more7, more8, more10, more11, more13, more19, more23];
...
//   // Proof carousel navigation - Large screens (4 cards)
//   const nextProofLg = () => {
//     setProofSlide((prev) => Math.min(prev + 4, proofImages.length - 4));
//   };

//   const prevProofLg = () => {
//     setProofSlide((prev) => Math.max(prev - 4, 0));
//   };

//   // Proof carousel navigation - Medium screens (2 cards)
//   const nextProofMd = () => {
//     setProofSlide((prev) => Math.min(prev + 2, proofImages.length - 2));
//   };

//   const prevProofMd = () => {
//     setProofSlide((prev) => Math.max(prev - 2, 0));
//   };

//   // Proof carousel navigation - Small screens (1 card)
//   const nextProofSm = () => {
//     setProofSlide((prev) => (prev + 1) % proofImages.length);
//   };

//   const prevProofSm = () => {
//     setProofSlide((prev) => (prev - 1 + proofImages.length) % proofImages.length);
//   };
...
//           {/* DSam's Proof Screenshots - Carousel */}
//           <motion.div
//             initial={{ opacity: 0, y: 30 }}
//             whileInView={{ opacity: 1, y: 0 }}
//             viewport={{ once: true }}
...
//                         }
//                       }}
//                       className="grid lg:grid-cols-4 gap-6 cursor-grab active:cursor-grabbing"
//                     >
//                       {proofImages.slice(proofSlide, proofSlide + 4).map((proof, index) => (
//                         <motion.div
//                           key={proofSlide + index}
//                           whileHover={{ y: -5 }}
...
//                             <img
//                               src={proof}
//                               alt={`DSam earnings proof ${proofSlide + index + 1}`}
...
//                 <button
//                   onClick={prevProofLg}
//                   disabled={proofSlide === 0}
//                   className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-14 w-12 h-12 bg-white rounded-full border-2 border-orange-500 hover:bg-orange-500 hover:text-white disabled:opacity-30 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center shadow-lg group z-10"
//                 >
//                   <ChevronLeft className="w-6 h-6 text-orange-500 group-hover:text-white" />
//                 </button>
//                 <button
//                   onClick={nextProofLg}
//                   disabled={proofSlide >= proofImages.length - 4}
//                   className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-14 w-12 h-12 bg-white rounded-full border-2 border-orange-500 hover:bg-orange-500 hover:text-white disabled:opacity-30 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center shadow-lg group z-10"
//                 >
//                   <ChevronRight className="w-6 h-6 text-orange-500 group-hover:text-white" />
//                 </button>
//               </div>
...
//                 {[...Array(Math.ceil(proofImages.length / 4))].map((_, index) => (
//                   <button
//                     key={index}
//                     onClick={() => setProofSlide(index * 4)}
//                     className={`transition-all duration-300 rounded-full ${
//                       Math.floor(proofSlide / 4) === index
...
//                         }
//                       }}
//                       className="grid grid-cols-2 gap-6 cursor-grab active:cursor-grabbing"
//                     >
//                       {proofImages.slice(proofSlide, proofSlide + 2).map((proof, index) => (
//                         <motion.div
//                           key={proofSlide + index}
//                           whileHover={{ y: -5 }}
//                           className="cursor-pointer"
...
//                 <button
//                   onClick={nextProofMd}
//                   disabled={proofSlide >= proofImages.length - 2}
//                   className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-14 w-12 h-12 bg-white rounded-full border-2 border-orange-500 hover:bg-orange-500 hover:text-white disabled:opacity-30 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center shadow-lg group z-10"
//                 >
//                   <ChevronRight className="w-6 h-6 text-orange-500 group-hover:text-white" />
//                 </button>
...
//               {/* Dots Navigation */}
//               <div className="flex justify-center gap-2 mt-8">
//                 {[...Array(Math.ceil(proofImages.length / 2))].map((_, index) => (
//                   <button
//                     key={index}
//                     onClick={() => setProofSlide(index * 2)}
//                     className={`transition-all duration-300 rounded-full ${
//                       Math.floor(proofSlide / 2) === index
//                         ? 'w-8 h-3 bg-orange-500'
//                         : 'w-3 h-3 bg-gray-300 hover:bg-gray-400'
//                     }`}
//                     aria-label={`Go to slide ${index + 1}`}
...
//                     >
//                       {proofImages.slice(proofSlide, proofSlide + 1).map((proof, index) => (
//                         <motion.div
//                           key={proofSlide + index}
//                           whileHover={{ y: -5 }}
//                           className="cursor-pointer"
...
//                             <div className="p-4 border-t border-gray-100">
//                               <p className="text-sm text-center text-gray-600 font-medium">
//                                 📊 Earnings Screenshot {proofSlide + 1} of {proofImages.length}
//                               </p>
//                             </div>
//                           </div>
//                         </motion.div>
...
//                 <button
//                   onClick={prevProofSm}
//                   className="absolute left-0 top-1/2 -translate-y-1/2 w-10 h-10 bg-white rounded-full border-2 border-orange-500 hover:bg-orange-500 hover:text-white transition-all duration-300 flex items-center justify-center shadow-lg group z-10"
//                 >
//                   <ChevronLeft className="w-5 h-5 text-orange-500 group-hover:text-white" />
//                 </button>
//                 <button
//                   onClick={nextProofSm}
//                   className="absolute right-0 top-1/2 -translate-y-1/2 w-10 h-10 bg-white rounded-full border-2 border-orange-500 hover:bg-orange-500 hover:text-white transition-all duration-300 flex items-center justify-center shadow-lg group z-10"
//                 >
//                   <ChevronRight className="w-5 h-5 text-orange-500 group-hover:text-white" />
//                 </button>
//               </div>
